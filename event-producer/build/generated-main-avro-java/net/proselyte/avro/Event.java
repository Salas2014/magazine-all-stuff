...
public class Event extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4820881028601692806L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Event\",\"namespace\":\"net.proselyte.avro\",\"fields\":[{\"name\":\"uid\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"subject\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"description\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public Event(java.lang.String uid, java.lang.String subject, java.lang.String description) {
    this.uid = uid;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: uid = value$ != null ? value$.toString() : null; break;
   ...
   */
  public static net.proselyte.avro.Event.Builder newBuilder() {
    return new net.proselyte.avro.Event.Builder();
  }
   ...
   * @return A new Event RecordBuilder
   */
  public static net.proselyte.avro.Event.Builder newBuilder(net.proselyte.avro.Event.Builder other) {
    if (other == null) {
      return new net.proselyte.avro.Event.Builder();
    } else {
      return new net.proselyte.avro.Event.Builder(other);
    }
  }
   ...
   * @return A new Event RecordBuilder
   */
  public static net.proselyte.avro.Event.Builder newBuilder(net.proselyte.avro.Event other) {
    if (other == null) {
      return new net.proselyte.avro.Event.Builder();
    } else {
      return new net.proselyte.avro.Event.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Event>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.proselyte.avro.Event.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.proselyte.avro.Event other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.uid)) {
        this.uid = data().deepCopy(fields()[0].schema(), other.uid);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.proselyte.avro.Event.Builder setUid(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.proselyte.avro.Event.Builder clearUid() {
      uid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.proselyte.avro.Event.Builder setSubject(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.proselyte.avro.Event.Builder clearSubject() {
      subject = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.proselyte.avro.Event.Builder setDescription(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.proselyte.avro.Event.Builder clearDescription() {
      description = null;
